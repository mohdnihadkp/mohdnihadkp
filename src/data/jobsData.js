export const jobs = [
  {
    ...
    list: [
      "For workflow, I use Jira as a management tool and Git/GitHub as a version control system.",
      "I work under the Scrum agile methodology, with 2-week sprints and two daily meetings (dailies) to plan the project and present progress.",
    ],
  },
  {
    title: "Frontend Developer - Vegna",
    time: ["05/2024 - 02/2024"],
    description: "Development and maintenance of user interfaces with:",
  ...
  },
  {
    ...
    description:
      "Development of responsive MVP fullstack web applications using technologies such as",
    list: [
